...
--}}
                ...
                <main class="col-lg-9">
                    ...
                    <div class="image_wrap">
                        ...
                        <img src="{{URL::to('/')}}{{$category->photo->file}}" style="width:847px;height:387px">
                            ...
                            {{--<div class="table_layout" id="products_container">--}}
                                ...
                                {{--<div class="container-fluid">--}}
                                    ...
                                    {{--<div class="table_row">--}}
                                        ...
                                        {{--@foreach($categoryrelatedproducts as $catpro)--}}
                                            {{--@foreach($catpro->products as $pro1)--}}
                                                ...
                                                {{--@if($test)--}}
                                                    ...
                                                    {{--<div class="col-md-4">--}}
                                                    {{--<br>--}}
                                                    {{--<div class="table_cell" style="height: 100px">--}}
                                                        ...
                                                        {{--<div class="product_item">--}}
                                                            ...
                                                            {{--<div class="image_wrap">--}}
                                                                ...
                                                                {{--<img src="{{URL::to('/')}}{{$pro1->photo->file}}" style="height: 150px;width: 200px;">--}}
                                        ...
                                        {{--@endforeach--}}
{{--<div class="row">--}}
    {{--{{$categoryrelatedproducts->render()}}--}}
{{--</div>--}}
                                    {{--</div>--}}
                    ...
                    <div class="section_offset">
                        ...
                        <div class="table_layout" id="products_container">
                            ...
                            @foreach($categoryrelatedproducts as $crproduct)
                                <!-- - - - - - - - - - - - - - Product - - - - - - - - - - - - - - - - -->

                                    <div class="table_cell col-sm-4 col-lg-4">
                                        ...
                                        <div class="product_item">
                                            ...
                                            <div class="image_wrap">
                                                ...
                                                <img src="{{URL::to('/')}}{{$crproduct->photo->file}}" style="height: 150px;width: 200px;" alt="">
                                                ...
                                                <div class="actions_wrap">
                                                    ...
                                                    <div class="centered_buttons">
                                                        ...
                                                        <a href="#" class="addtocart button_blue middle_btn add_to_cart" data-id="{{$crproduct->id}}">Add to Cart</a>
                                            ...
                                            <div class="description">
                                                ...
                                                <a href="/productdetail/{{$crproduct->id}}">{{$crproduct->P_name}}</a>

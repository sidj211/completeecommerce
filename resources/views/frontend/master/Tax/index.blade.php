                                    ...
                                    <div class="modal-body"><!-- Column -->
                                        <div class="modal-body">
                                            <div class="col-lg-12">
                                                ...
                                                {!! Form::open(['method'=>'post','action'=>'TaxController@store']) !!}
                                                {{csrf_field()}}



                                                <div class="form-group  has-success">
                                                    <label style="float:left;margin-left: 12px;" for="inputHorizontalSuccess" class="col-form-label">Tax</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="value" class="form-control " id="inputHorizontalSuccess" placeholder="Percentage">

                                                    </div>
                                                </div>
                                                <button type="submit" style="float: left;margin-left: 9px;" class="btn waves-effect waves-light btn-rounded btn-outline-success">Add Tax</button>
                                        ...
                                        @foreach($taxes as $tax)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{route('products.edit',$tax->id)}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>

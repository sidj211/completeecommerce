                                        ...
                                        <div class="modal-body">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group  has-success">
                                                    <label style="float:left;margin-left: 12px;" for="inputHorizontalSuccess" class="col-form-label">Category</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="name" class="form-control " id="inputHorizontalSuccess" placeholder="Category Name">
                                                    </div>
                                                ...
                                                <button type="submit" style="float: left;margin-left: 9px;" class="btn waves-effect waves-light btn-rounded btn-outline-success">Add Category</button>
                                        ...
                                        <table class="table color-table success-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{route('products.edit',$category->id)}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
